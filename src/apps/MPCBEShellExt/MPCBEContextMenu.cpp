...
#define MPC_WND_CLASS_NAME L"MPC-BE-VB"

// CMPCBEContextMenu
#define ID_MPCBE_PLAY 0

#define PLAY_MPC_RU  L"&������������� � MPC-BE"
#define ADDTO_MPC_RU L"&�������� � �������� MPC-BE"

#define PLAY_MPC_EN  L"&Play with MPC-BE-VB"
#define ADDTO_MPC_EN L"&Add to MPC-BE-VB Playlist"
